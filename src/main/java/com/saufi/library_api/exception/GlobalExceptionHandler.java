...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleCustomException(CustomHttpException ex,
    ...
    public ResponseEntity<ErrorResponse> handleValidationException(
        ...
        List<ErrorResponse.ValidationError> validationErrors = ex.getBindingResult()
                ...
                .map(fieldError -> ErrorResponse.ValidationError.builder()
                        ...
                        .rejectedValue(maskSensitive(fieldError.getField(), fieldError.getRejectedValue()))
